...
public class Formulario extends JPanel {
    ...
    public Formulario() {
        ...
        gcEtiqueta.insets = new Insets(Tema.ESP_SM, 0, Tema.ESP_SM, Tema.ESP_MD);

        gcCampo.gridx = 1;
        gcCampo.weightx = 1;
        gcCampo.fill = GridBagConstraints.HORIZONTAL;
        gcCampo.insets = new Insets(Tema.ESP_SM, 0, Tema.ESP_SM, 0);
    }

    /** Fila etiqueta + control. */
    public Formulario campo(String etiqueta, JComponent control) {
        // ningun control impone su ancho al formulario: la celda se rellena sola
    ...
    public Formulario campo(String etiqueta, JComponent control, String ayuda) {
        ...
        JLabel a = Ui.micro(ayuda);
        envoltorio.add(a, BorderLayout.SOUTH);
        return campo(etiqueta, envoltorio);
    }

    /** Encabezado de grupo que abarca las dos columnas. */
    public Formulario grupo(String texto) {
        ...
        gc.insets = new Insets(fila == 0 ? 0 : Tema.ESP_LG, 0, Tema.ESP_SM, 0);
        ...
        p.add(Ui.separador(), BorderLayout.CENTER);
